    ...
    , ui(new Ui::MainWindow)
{
    ...
    //changeWidget
    connect(ui->home1, &QPushButton::toggled, [this](bool checked) { on_home1_toggled(ui, checked); });
    connect(ui->home2, &QPushButton::toggled, [this](bool checked) { on_home2_toggled(ui, checked); });
